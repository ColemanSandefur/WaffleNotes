  ...
  "mb-2 flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        icon: "flex size-8 shrink-0 items-center justify-center rounded-lg bg-muted text-primary [&_svg:not([class*='size-'])]:size-6",
      },
    },
    defaultVariants: {
      variant: "default",
...
function EmptyMedia({
  ...
  variant = "default",
  ...props
}: HTMLAttributes<HTMLDivElement> & VariantProps<typeof emptyMediaVariants>) {
  return (
    <div
...
function EmptyTitle({ className, ...props }: HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      ...
      className={cn(
        "font-serif text-primary text-lg tracking-tight",
        className,
      )}
      {...props}
    />
